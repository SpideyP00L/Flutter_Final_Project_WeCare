          ...
          Column(
            ...
            children: [
              _buildInfoRow('Blood Pressure:',
                  patientData['Tests']['Blood_Pressure'] ?? 'N/A'),
              _buildInfoRow(
                  'Heart Rate:', patientData['Tests']['Heart_Rate'] ?? 'N/A'),
              _buildInfoRow('Respiratory Rate:',
                  patientData['Tests']['Respiratory_Rate'] ?? 'N/A'),
              _buildInfoRow('Oxygen Saturation:',
                  patientData['Tests']['Oxygen_Saturation'] ?? 'N/A'),
              _buildInfoRow('Body Temperature:',
                  patientData['Tests']['Body_Temperature'] ?? 'N/A'),
            ],
          ),
        if (patientData['Tests'] == null ||
                ...
                Column(
                  ...
                  children: [
                    ...
                    _buildInfoRow('Heart Rate:',
                        patientData['Tests']['Heart_Rate'] ?? 'N/A'),
                    _buildInfoRow('Respiratory Rate:',
                        patientData['Tests']['Respiratory_Rate'] ?? 'N/A'),
                    _buildInfoRow('Oxygen Saturation:',
                        patientData['Tests']['Oxygen_Saturation'] ?? 'N/A'),
